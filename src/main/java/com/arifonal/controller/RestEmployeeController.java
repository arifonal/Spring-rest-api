package com.arifonal.controller;
...
import com.arifonal.services.EmployeeService;
...
public class RestEmployeeController {
	...
	public List<Employee> getAllEmployeeList(){
		...
		return employeeService.getAllEmpoEmployeeList();
	}
	...
	public List<Employee> getEmployeeWithParams(@RequestParam(name = "firstName", required = false)
															String firstName,
